...
import com.hibernateentityclass.Employee;
// Buiseness logic 3
public class EmployeeService {
	...
	public Integer addEmployee(String fname, String lname, int salary) {
		...
		try {
			...
			sessionObj = Hibernateutilclass.buildSessionFactory().openSession();
...
/* Method to update an employee in the database business logic */
		public void updateEmployeeDetails(Integer id, int salary){
